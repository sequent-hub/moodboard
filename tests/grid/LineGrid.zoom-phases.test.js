...
describe('LineGridZoomPhases', () => {
    it('matches configured checkpoints with small and big grids only', () => {
        const checkpoints = [
            { z: 0.92, major: 18, second: 72 },
            { z: 1.0, major: 19, second: 76 },
            { z: 0.82, major: 16, second: 64 },
            { z: 0.73, major: 60 },
            { z: 0.33, major: 26, second: 104 },
            { z: 0.30, major: 24, second: 96 },
            { z: 0.26, major: 21, second: 84 },
            { z: 0.24, major: 19, second: 76 },
            { z: 0.21, major: 17, second: 68 },
            { z: 0.19, major: 60 },
            { z: 0.17, major: 54, second: 216 },
            { z: 0.15, major: 48, second: 192 },
            { z: 0.13, major: 42, second: 168 },
            { z: 0.12, major: 38, second: 152 },
            { z: 0.11, major: 34, second: 136 },
            { z: 0.10, major: 30, second: 120 },
            { z: 0.084, major: 27, second: 108 },
            { z: 0.076, major: 24, second: 96 },
            { z: 0.07, major: 22, second: 88 },
            { z: 0.06, major: 20, second: 80 },
            { z: 0.054, major: 17, second: 68 },
            { z: 0.046, major: 60 },
            { z: 0.04, major: 55, second: 220 },
            { z: 0.036, major: 49, second: 196 },
            { z: 0.034, major: 44, second: 176 },
            { z: 0.03, major: 39, second: 156 },
            { z: 0.026, major: 35, second: 140 },
            { z: 0.024, major: 31, second: 124 },
            { z: 0.022, major: 27, second: 108 },
            { z: 0.02, major: 25, second: 100 },
            { z: 0.018, major: 22, second: 88 },
            { z: 0.016, major: 20, second: 80 },
            { z: 0.014, major: 17, second: 68 },
            { z: 0.65, major: 52, second: 208 },
            { z: 0.58, major: 46, second: 184 },
            { z: 0.52, major: 42, second: 168 },
            { z: 0.46, major: 37, second: 148 },
            { z: 0.41, major: 33, second: 132 },
            { z: 0.37, major: 30, second: 120 },
            { z: 1.03, major: 20, second: 80 },
            { z: 1.15, major: 23, second: 92 },
            { z: 1.29, major: 25, second: 100 },
            { z: 1.44, major: 30, second: 120 },
            { z: 1.62, major: 35, second: 140 },
            { z: 1.81, major: 35, second: 140 },
            { z: 2.03, major: 40, second: 160 },
            { z: 2.27, major: 45, second: 180 },
            { z: 2.54, major: 50, second: 200 },
            { z: 2.85, major: 60 },
            { z: 3.19, major: 64 },
            { z: 3.57, major: 70 },
            { z: 4.0, major: 80 },
