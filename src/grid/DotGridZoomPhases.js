...
export const DOT_CHECKPOINTS = [
    ...
    { zoomPercent: 7.0, spacing: 8, dotRadius: 1, color: 0xE8E8E8 },
    { zoomPercent: 7.6, spacing: 10, dotRadius: 1, color: 0xE8E8E8 },
    { zoomPercent: 8.4, spacing: 12, dotRadius: 1, color: 0xE8E8E8 },
