...
export class ChatMessageList {
    ...
    /**
     * @param {Array<{id: string, role: string, content: string, pending?: boolean, error?: string, imageUrl?: string, imageBase64?: string, mimeType?: string}>} messages
     */
    render(messages) {
    ...
    _renderMessage(msg) {
        ...
        } else if (msg.imageUrl || msg.imageBase64) {
